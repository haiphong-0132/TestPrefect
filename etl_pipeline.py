...
def etl_pipeline(sheet_url: str = 'YOUR_SHEET_URL', table_name: str = 'Customers'):
    # Extracted data
    df = extract_from_google_sheet(sheet_url)
...
if __name__ == '__main__':
    etl_pipeline('https://docs.google.com/spreadsheets/d/1ZGbOTAP2W2MIfo5HWvMR40RF6oWSUfR4Va9E_RvczWk/edit?gid=1647286845#gid=1647286845', 'Customers')